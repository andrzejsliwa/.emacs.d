...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#1B1E1C" :foreground "#F8f8f2"))))
 ...
 '(mode-line-inactive ((t (:foreground "#465457" :background "#000000"
                           :box nil))))
 '(mode-line-mousable ((t (:foreground "#465457" :background "#000000"))))
 ...
 '(font-lock-type-face ((t (:foreground "#f92672"))))
 ...
 '(vertical-border ((t (:foreground "#232526"))))
 '(sp-show-pair-match-face ((t (:foreground "#A6E22E" :background nil))))
 '(sp-pair-overlay-face ((t (:background "#465457"))))
 '(highlight ((t (:background "#C4BE89"))))
 '(which-func ((t (:foreground "#F92672"))))
 ...
 '(clojure-test-failure-face ((t (:background "#F92672" :foreground "#000000"))))
 ...
 '(ace-jump-face-foreground ((t (:foreground "#F92672"))))
 '(edb-breakpoint-face ((t (:background "#333333" ))))
 '(compilation-error ((t (:foreground "#000000" :background "#F92672" :weight bold :underline nil))))
 '(flycheck-error ((t (:foreground "#000000" :background "#F92672" :weight bold :underline nil))))
 '(flycheck-warning ((t (:foreground "#000000" :background "#AE81FF" :weight bold :underline nil))))
 '(flymake-errline ((t (:foreground "#000000" :background "#F92672" :weight bold :underline nil))))
 '(flymake-warnline ((t (:foreground "#000000" :background "#AE81FF" :weight bold :underline nil))))
)
